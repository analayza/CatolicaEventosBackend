import { deleteEventRepository, findEventByIdRepository } from "../../repository/eventRepository.js";

export default async function deleteEventService(id_event, id_admin) {
    try{
        ...
        const deleteEvent = await deleteEventRepository(id_event);
        return deleteEvent;
